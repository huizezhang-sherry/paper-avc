...
tibble(city = str_remove(files, "data/pm10-") |> str_remove(".csv")) |> bind_cols(pred_res) |>
...
[Sherry: Summarize the results from the 40 cities, along with 2x2 table of outcome vs. predicted]
