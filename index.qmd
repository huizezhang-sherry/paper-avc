...
#| fig-cap: Average step count across 300 simulated 30-day periods. The orange points indicate instances where the average step count fails outside the [8,500, 9,500] interval, representing an unexpected outcome in this scenario. 
set.seed(1234)
...
#| fig.width: 8
#| fig.heigh: 2
#| fig-cap: Logic regression model fitted to the three checks. The model suggests the rule (quantile(step, 0.6) > 10,000 OR quantile(step, 0.4) < 8,000) AND sd(step) < 2,500
