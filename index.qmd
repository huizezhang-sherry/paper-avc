...
* describe/ define what analysis plan is, expectation (outcome and plan)
    ...
    * some expectations can be about data: e.g. check temporal gaps in time series data. Some others are statistical checks: sample size, outliers, model specification, or checks based on domain knowledge: include temperature in the mortality ~ PM10 model.
