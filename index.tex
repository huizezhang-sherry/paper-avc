...
i Run `dplyr::last_dplyr_warnings()` to see the 989 remaining warnings.
\end{verbatim}
...
Checks & Precision & Recall & Independence & Harmonic & Arithmetic\\
\midrule
Check 1: cor(m, PM10) < -0.03 & 0.518 & 0.888 & 1.000 & 0.740 & 0.802\\
Check 2: cor(m, tmp) > -0.35 & 0.259 & 0.543 & 1.000 & 0.448 & 0.601\\
Check 3: mortality outlier & 0.281 & 0.833 & 1.000 & 0.521 & 0.705\\
Check 4: PM10 outlier & 0.289 & 0.871 & 1.000 & 0.535 & 0.720\\
Logic regression: (check 1) AND ((check 2) OR (check 3 AND check 4)) & 0.874 & 0.667 & 0.779 & 0.764 & 0.773\\
\bottomrule
\end{tabular}}
