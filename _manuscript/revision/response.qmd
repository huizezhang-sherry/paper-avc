...
2.  Figure 2: Quadratic mean is mentioned in the text but not shown in the SCORE box. **A: easy. TODO**
...
8.  Section 5.1, paragraph 1: Gaussian copula does not allow tail dependence. So by imposing a Gaussian copula, it is assumed that there is no tail dependence in these three variables. As questioned in one of my general comments, this might not be desirable. **A: ask Roger** may or may not being able to simulate a particular characteristic of the data and generate
