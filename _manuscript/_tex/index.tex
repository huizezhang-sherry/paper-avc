...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.5368}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1053}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0737}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0737}}
...
described in Section~\ref{sec-method} can be applied. The dataset is
from New York City, and contains daily PM10, mortality, and temperature
values from 1992--2000.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.6106}}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0973}}@{}}
...
\toprule
City & \makecell[l]{PM10\\Coefficient} & \makecell[l]{Outcome\\Unexpected} & \makecell[l]{Predicted\\Unexpected} & \makecell[l]{Correlation\\Mortality\\PM10} & \makecell[l]{Correlation\\Mortality\\Temperature} & \makecell[l]{Mortality\\Outlier} & \makecell[l]{PM10\\Outlier}\\
\midrule
